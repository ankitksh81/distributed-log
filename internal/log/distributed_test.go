...
// TestMultipleNodes set up a three-server cluster
func TestMultipleNodes(t *testing.T) {
	...
	// We test our replication by appending some records to our leader
	// server and check that Raft replicated the records to its followers.
